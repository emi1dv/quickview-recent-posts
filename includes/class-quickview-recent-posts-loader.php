 ...
 */
class Quickview_Recent_Posts_Loader {
	 ...
	 * @param    object    $object     A reference to the instance of the object on which the callback is defined.
	 * @param    string    $callback   The name of the function definition on the $object.
	 */
	public function add_shortcode($tag, $object, $callback) {
		add_shortcode($tag, array($object, $callback));
	}
